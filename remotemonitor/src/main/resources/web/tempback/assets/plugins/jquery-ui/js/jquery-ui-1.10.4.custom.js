		...
		$.each(inst.sortables, function() {
			...
			if(innermostIntersecting) {
				...
				if(this.instance.isOver) {
					...
					//Now we remove our currentItem, the list group clone again, and the placeholder, and animate the helper tempback to it's original size
...
$.widget( "ui.spinner", {
	...
	_adjustValue: function( value ) {
		...
		// - rounding is based on 0, so adjust tempback to our base
		value = base + aboveMin;
